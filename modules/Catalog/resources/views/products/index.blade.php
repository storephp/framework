                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item"
                                    href="{{ route('store.dashboard.catalog.products.create', ['simple']) }}">
                                ...
                                <a class="dropdown-item"
                                    href="{{ route('store.dashboard.catalog.products.create', ['configurable']) }}">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-list flex-nowrap">
                                                    <a href="{{ route('store.dashboard.catalog.products.edit', [$product]) }}"
                                                        class="btn">
                                                        Edit
                                                    </a>
