                        ...
                        <div class="card-body">
                            ...
                            <div class="list-group list-group-transparent">
                                @foreach ($from_tabs as $from_tab)
                                    <a href="#" class="list-group-item list-group-item-action d-flex align-items-center @if($from_tab['id'] == $tab) active @endif" wire:click="setTab('{{ $from_tab['id'] }}')">{{ $from_tab['name'] }}</a>
                                @endforeach
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    @foreach ($from_tab['fields'] as $field)
                                        @if ($field['type'] == 'select')
                                            <x-outmart-select label="{{ $field['label'] }}" model="{{ $field['model'] }}" :options="$field['options']" />
                                        @endif

                                        @if ($field['type'] == 'text')
                                            <x-outmart-input-text label="{{ $field['label'] }}" model="{{ $field['model'] }}" />
                                        @endif
                                    @endforeach
